...
<table class="twelve columns" bgcolor="#999999">
<tr>
<td class="twelve sub-columns" bgcolor="#999999">
</td>
...
<tr>
<td class="panel">
    <p>Este email ha sido enviado desde la página web de <a href="http://www.laparaguaya.com.py/">La Paraguaya S.A. de Seguros »</a></p>
</td>
<td class="expander"></td>
</tr>
</table>
    ...
    <table class="twelve columns">
        <tbody><tr>
            <td>
                <p>Esta denuncia online es simplemente un aviso para la compañía acerca del siniestro de tal modo que podamos agilizar los arreglos del siniestro del automóvil. </p>
                <p>Si desea, puede descargar el formulario de denuncia oficial, completarlo, firmarlo, escanearlo y enviar a <strong>siniestros@laparaguaya.com.py</strong> o bien acercarlo a la compañía.</p>
            </td>
            <td class="expander"></td>
            </tr>
        </tbody></table>
...
<tr>
    <td class="last left-text-pad">
        ...
        <p><strong>Número de Registro: </strong> '.  $registro.' </p>
...
<tr>
    <td class="last left-text-pad">
        ...
        <p><strong>Tipo: </strong> '.  $tipoauto.' </p>
        <p><strong>Marca: </strong> '.  $marcaauto.' </p>
        <p><strong>Motor Nº: </strong> '.  $numotor.' </p>
        <p><strong>Chasis Nº: </strong> '.  $chasis.' </p>
        <p><strong>Chapa Nº: </strong> '.  $chapa.' </p>
        <p><strong>Póliza Nº: </strong> '.  $numpoliza.' </p>
    </td>
</tr>
    <td class="expander"></td>
<tr>
    <td class="last left-text-pad">
        <h5>Datos de lo ocurrido</h5>
        <p><strong>Fecha del accidente: </strong> '.  $fechaccidente.' </p>
        <p><strong>Lugar del Accidente: </strong> '.  $lugaraccidente.' </p>
        <p><strong>Narración: </strong> '.  $relato.' </p>
        <p><strong>Testigos: </strong> '.  $testigos.' </p>
        <p><strong>Culpabilidad: </strong> '.  $culpabilidad.' </p>
        <p><strong>Intervención de la policía: </strong> '.  $policia.' </p>
        <p><strong>Lugar donde se podrá inspeccionar el vehículo siniestrado: </strong> '.  $lugar.' </p>
    </td>
</tr>
<td class="expander"></td>
<tr>
    <td class="last left-text-pad">
        <h5>Datos de Terceros</h5>
        <p><strong>Nombre y Apellido: </strong> '.  $nombretercero.' </p>
        <p><strong>Numero de C.I.: </strong> '.  $citercero.' </p>
        <p><strong>Dirección: </strong> '.  $direcciontercero.' </p>
        <p><strong>Número de chapa: </strong> '.  $chapatercero.' </p>
        <p><strong>Asegurado en: </strong> '.  $aseguradoratercero.' </p>
